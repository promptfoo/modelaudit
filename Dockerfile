...
RUN apt-get update \
    && apt-get install --yes --no-install-recommends --only-upgrade \
        bsdutils gzip libc-bin libc6 libblkid1 libcap2 liblastlog2-2 libmount1 libpcre2-8-0 \
        libsmartcols1 libsqlite3-0 libssl3t64 libsystemd0 libudev1 libuuid1 login mount \
        perl-base util-linux \
