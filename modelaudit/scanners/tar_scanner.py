...
DEFAULT_MAX_TAR_DEPTH = 5
DEFAULT_MAX_TAR_ENTRIES = 10000
...
class TarScanner(BaseScanner):
    ...
    def __init__(self, config: dict[str, Any] | None = None) -> None:
        ...
        self.max_depth = self.config.get("max_tar_depth", DEFAULT_MAX_TAR_DEPTH)
        self.max_entries = self.config.get("max_tar_entries", DEFAULT_MAX_TAR_ENTRIES)
