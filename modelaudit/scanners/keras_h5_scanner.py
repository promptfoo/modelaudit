    ...
    def _check_hdf5_external_references(self, h5_file: Any, result: ScanResult, source_path: str) -> None:
        ...
        if vuln_status is False and isinstance(keras_version, str):
            result.add_check(
                ...
                passed=False,
                message=(
                    f"HDF5 external references detected in weights, and file metadata claims Keras {keras_version} "
                    "outside the known CVE-2026-1669 vulnerable ranges; metadata-only assessment is inconclusive "
