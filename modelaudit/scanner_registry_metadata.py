...
LEGAL_TEXT_SIDECAR_BASENAMES = frozenset({"license", "notice"})
LEGAL_TEXT_SIDECAR_EXTENSIONS = frozenset({"", ".txt", ".md", ".markdown", ".rst"})
MAIN_OWNED_LEGAL_TEXT_FILENAMES = frozenset({"license.md", "license.rst", "license.txt"})
