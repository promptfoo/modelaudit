...
id(tensorflow_dot_core_dot_framework_dot_full__type__pb2)
id(tensorflow_dot_core_dot_framework_dot_resource__handle__pb2)
...
del tensorflow_dot_core_dot_framework_dot_resource__handle__pb2
