...
from .config import cloud_config, config, get_user_email, validate_api_host_for_bearer_auth
...
class AuthClient:
    ...
    def validate_and_set_api_token(self, token: str, api_host: str | None = None) -> dict[str, Any]:
        ...
        """
        host = validate_api_host_for_bearer_auth(api_host or config.get_api_host())
    ...
    def get_user_info(self) -> dict[str, Any]:
        ...
        api_host = validate_api_host_for_bearer_auth(config.get_api_host())
