...
def get_cve_2025_49655_explanation(issue_type: str) -> str:
    ...
    CVE-2025-49655 (CVSS 9.8 CRITICAL): TorchModuleWrapper in Keras >= 3.11.0
    and < 3.11.3 calls torch.load(weights_only=False) in from_config(), enabling
    arbitrary code execution via pickle deserialization. Fixed in Keras 3.11.3.
    """
    explanations = {
        "torch_module_wrapper": (
            "CVE-2025-49655: The TorchModuleWrapper layer in Keras >= 3.11.0 and < 3.11.3 calls "
