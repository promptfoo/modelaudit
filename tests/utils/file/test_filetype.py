...
@pytest.mark.parametrize("filename", ["model.json", "model.onnx"])
...
def test_detect_oversized_generic_json_fails_closed_when_mxnet_structure_is_undecidable(tmp_path: Path) -> None:
