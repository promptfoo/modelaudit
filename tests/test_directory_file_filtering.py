...
class TestDirectoryFileFiltering:
    ...
    def test_skip_file_types_enabled(self, safe_tmp_path):
        """Test that non-model files are skipped when skip_file_types=True."""
        tmp_dir = str(safe_tmp_path)
    ...
    def test_nested_directories(self, safe_tmp_path):
        """Test file filtering in nested directories."""
        tmp_dir = safe_tmp_path
        ...
        results = scan_model_directory_or_file(str(tmp_dir))
    ...
    def test_license_files_metadata_collected(self, safe_tmp_path):
