...
class TestSecretsDetector:
    ...
    def test_detect_openai_keys(self):
        ...
        text = "OPENAI_API_KEY=sk-abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGH"
        findings = detector.scan_text(text)
        assert len(findings) > 0
    ...
    def test_high_entropy_detection(self):
        ...
        # High entropy regions should be detected
        assert any(f["type"] == "high_entropy_region" for f in findings)
    ...
    def test_scan_dict(self):
        ...
        data = {
            "model_config": {
                "api_key": "sk-abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGH",
...
class TestPickleScannerWithSecrets:
    ...
    def test_secrets_check_disabled(self, tmp_path):
        ...
        data = {"api_key": "sk-abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGH"}
