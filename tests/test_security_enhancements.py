...
class TestJoblibScannerSecurity:
    ...
    def test_compression_bomb_detection(self, safe_tmp_path):
        ...
        joblib_file = safe_tmp_path / "bomb.joblib"
    ...
    def test_large_file_protection(self, safe_tmp_path):
    ...
    def test_decompressed_size_limit(self, safe_tmp_path):
        ...
        joblib_file = safe_tmp_path / "large_decompressed.joblib"
        joblib_file.write_bytes(compressed)
    ...
    def test_valid_compressed_joblib(self, safe_tmp_path):
        ...
        joblib_file = safe_tmp_path / "valid.joblib"
        joblib_file.write_bytes(compressed)
    ...
    def test_lzma_compressed_joblib(self, safe_tmp_path):
        ...
        joblib_file = safe_tmp_path / "lzma.joblib"
        joblib_file.write_bytes(compressed)
    ...
    def test_direct_pickle_joblib(self, safe_tmp_path):
        ...
        joblib_file = safe_tmp_path / "direct.joblib"
    ...
    def test_invalid_compression_format(self, safe_tmp_path):
        ...
        joblib_file = safe_tmp_path / "invalid.joblib"
    ...
    def test_file_read_chunk_limit(self, safe_tmp_path):
        ...
        limit_file = safe_tmp_path / "at_limit.joblib"
...
class TestNumPyScannerSecurity:
    ...
    def test_negative_dimension_rejection(self, safe_tmp_path):
        ...
        npy_file = safe_tmp_path / "negative_dims.npy"
    ...
    def test_too_many_dimensions_rejection(self, safe_tmp_path):
        ...
        npy_file = safe_tmp_path / "many_dims.npy"
    ...
    def test_dimension_size_limit(self, safe_tmp_path):
        ...
        npy_file = safe_tmp_path / "large_dim.npy"
    ...
    def test_dangerous_dtype_rejection(self, safe_tmp_path):
        """Test rejection of dangerous data types."""
        scanner = NumPyScanner()

        # Create numpy file with object dtype manually
        npy_file = safe_tmp_path / "object_dtype.npy"
    ...
    def test_array_size_overflow_protection(self, safe_tmp_path):
        ...
        npy_file = safe_tmp_path / "overflow.npy"
    ...
    def test_valid_numpy_array_still_works(self, safe_tmp_path):
    ...
    def test_numpy_version_2_format(self, safe_tmp_path):
        ...
        npy_file = safe_tmp_path / "version2.npy"
        np.save(npy_file, arr)
    ...
    def test_large_itemsize_rejection(self, safe_tmp_path):
        ...
        npy_file = safe_tmp_path / "large_itemsize.npy"
    ...
    def test_void_dtype_rejection(self, safe_tmp_path):
        """Test rejection of void dtype."""
        scanner = NumPyScanner()

        # Create numpy file with void dtype manually
        npy_file = safe_tmp_path / "void_dtype.npy"
    ...
    def test_unsupported_numpy_version(self, safe_tmp_path):
        """Test handling of unsupported NumPy file versions."""
        scanner = NumPyScanner()

        # Create numpy file with unsupported version manually
        npy_file = safe_tmp_path / "unsupported_version.npy"
...
class TestConfigurableLimits:
    ...
    def test_joblib_custom_limits(self, safe_tmp_path):
    ...
    def test_numpy_custom_limits(self, safe_tmp_path):
