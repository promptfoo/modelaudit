...
class TestShouldSkipPatternForFramework:
    ...
    def test_attacker_controlled_filename_context_does_not_skip(
        self,
        knowledge_base: FrameworkKnowledgeBase,
    ) -> None:
    ...
    def test_attacker_controlled_directory_context_does_not_skip(
        self,
        knowledge_base: FrameworkKnowledgeBase,
    ) -> None:
