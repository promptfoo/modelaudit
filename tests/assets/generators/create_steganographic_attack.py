...
def create_steganographic_attack(output_path=None):
    ...
    legitimate_model = collections.OrderedDict([
        ...
        ('features.0.weight', f'<Tensor shape=(64, 3, 7, 7)>'),
        ('features.0.bias', f'<Tensor shape=(64,)>'),
        ('features.3.weight', f'<Tensor shape=(64, 64, 3, 3)>'),
        ('features.3.bias', f'<Tensor shape=(64,)>'),
        ('features.6.weight', f'<Tensor shape=(128, 64, 3, 3)>'),
        ('features.6.bias', f'<Tensor shape=(128,)>'),
        ('classifier.weight', f'<Tensor shape=(1000, 128)>'),
        ('classifier.bias', f'<Tensor shape=(1000,)>'),
