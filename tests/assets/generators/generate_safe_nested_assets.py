...
def generate_safe_nested_assets():
    ...
    safe_model_with_tokens = {
        "model_name": "legitimate-bert-model",
        "version": "1.0.0",
        "config": {
            "architecture": "transformer",
            # These look like base64 but are legitimate config strings
            "tokenizer_config": "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/==",
            "model_hash": "sha256:" + "a1b2c3d4e5f6" * 10,  # Hex-like but legitimate
        },
        "weights": {
            "layer1": [0.1, 0.2, 0.3] * 100,  # Numerical data
            "layer2": [0.4, 0.5, 0.6] * 100,
        },
        # JWT token (legitimate use case for base64 in models)
        ...
        "metadata": {
            ...
            "description": "This is a legitimate model with some base64-like strings that should not trigger false positives"
        }
    }
