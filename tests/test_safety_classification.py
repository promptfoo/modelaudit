...
class TestSafetyClassification:
    ...
    def test_ml_framework_coverage(self):
        ...
        ml_frameworks = [
            "numpy", "torch", "tensorflow", "sklearn", "scipy", "pandas",
            "matplotlib", "PIL", "cv2", "h5py", "transformers", "datasets",
    ...
    def test_dangerous_modules_excluded(self):
        ...
        dangerous_modules = [
            "os", "sys", "subprocess", "runpy", "commands", "webbrowser",
            "importlib", "shutil", "tempfile", "pty", "platform", "ctypes", "socket"
        ]
    ...
    def test_builtin_safety_restrictions(self):
        ...
        # builtins should not be in SAFE_GLOBALS (all operations require review)
        assert "builtins" not in SAFE_GLOBALS
        assert "__builtin__" not in SAFE_GLOBALS  
