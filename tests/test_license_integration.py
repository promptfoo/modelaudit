...
class TestLicenseIntegration:
    ...
    def test_license_file_detection(self, test_data_dir):
        ...
        assert metadata.get("is_dataset") is True, (
    ...
    def test_unlicensed_dataset_detection_function(self, test_data_dir):
        ...
        assert any(name.endswith(".json") for name in unlicensed_names), (
            "Should detect JSON dataset"
        )
        assert any(name.endswith(".csv") for name in unlicensed_names), (
    ...
    def test_large_file_license_scanning(self, test_data_dir):
        ...
        if embeddings_file.exists():
            ...
            if file_size > 100 * 1024:  # > 100KB
                assert str(embeddings_file) in unlicensed, (
