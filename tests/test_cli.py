...
@patch("modelaudit.utils.huggingface.is_huggingface_url")
@patch("modelaudit.cli.download_model")  # Patch where it's used, not where it's defined
@patch("modelaudit.cli.scan_model_directory_or_file")  # Patch where it's used in CLI
@patch("shutil.rmtree")
...
@patch("modelaudit.utils.huggingface.is_huggingface_url")
@patch("modelaudit.cli.download_model")  # Patch where it's used
...
def test_scan_mixed_paths_and_urls():
    ...
    with patch("modelaudit.utils.huggingface.is_huggingface_url") as mock_is_hf, patch("os.path.exists") as mock_exists:
