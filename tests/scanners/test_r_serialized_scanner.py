...
@pytest.mark.parametrize(
    ...
    [
        ...
        'list(token = ("standard"))',
        'list(token = (x = "standard"))',
        'list(token = {"standard"; value})',
        'list(token = { x = 1; "standard" })',
        'list(token = { x = "standard"; x })',
        ...
        'list(token = x %custom% "standard")',
        'list(token = x % custom op % "standard")',
        'list(token = x %\tcustom% "standard")',
        'list(token = x %custom#op% "standard")',
        'list(token = x %% "standard")',
        'list(token = { x <- 1; "standard" })',
        ...
        'package::"1"[token = "standard"]',
        'object$x[token = r"(standard)"]',
        'object$"x"[token = "standard"]',
        'object$`1`[token = r"(standard)"]',
        'object@x[token = "standard"]',
        'list(token == "SECRET_VALUE")',
        'if (token == r"(SECRET_VALUE)") NULL',
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        'list(token = x %bad\n% "NEWLINE_INFIX_SECRET")',
        'list(token = x %bad # gap\n% "COMMENTED_INFIX_SECRET")',
        ...
        'x if (TRUE) list(token = "BAD_IF_BODY_CALL_SECRET")',
        'x if (TRUE) list(token = "BAD_IF_BODY_SECRET")',
        'x if (TRUE) y[token = "BAD_IF_BODY_SUBSCRIPT_SECRET"]',
        ...
        'list(token = x = "NESTED_EQUALS_SECRET")',
        ...
        'x$1[token = "BAD_DOLLAR_NUM_SECRET"]',
        'x$TRUE[token = "BAD_DOLLAR_RESERVED_SECRET"]',
        'x@1[token = "BAD_SLOT_NUM_SECRET"]',
        'x@..1[token = "BAD_SLOT_DOT_ARGUMENT_SECRET"]',
        '(x y)[token = "BAD_GROUPED_SUBSCRIPT_SECRET"]',
        '(x, y)[token = "COMMA_GROUPED_SUBSCRIPT_SECRET"]',
        '(x; y)[token = "SEMICOLON_GROUPED_SUBSCRIPT_SECRET"]',
        '()[token = "EMPTY_GROUPED_SUBSCRIPT_SECRET"]',
        'pkg::1[token = "BAD_NAMESPACE_NUM_SECRET"]',
        'pkg::TRUE[token = "BAD_NAMESPACE_RESERVED_SECRET"]',
        'pkg:::...[token = "BAD_NAMESPACE_ELLIPSIS_SECRET"]',
        'x$$y(token = "DOUBLE_DOLLAR_CALL_SECRET")',
        'x::y::z(token = "CHAINED_NS_CALL_SECRET")',
    ],
)
