...
class TestKerasZipScanner:
    ...
    def test_shared_keras_version_suffix_classifier_rejects_partial_matches(self) -> None:
        ...
        assert KerasZipScanner._is_vulnerable_to_cve_2025_12058("3.12.0rc1garbage") is None
        assert KerasZipScanner._is_vulnerable_to_cve_2026_1669("3.12.1rc1garbage") is None
