...
class TestOsSystemDetection:
    ...
    def test_detect_os_system(self, safe_tmp_path):
        ...
        test_file = safe_tmp_path / "os_system.pkl"
    ...
    def test_detect_os_spawn(self, safe_tmp_path):
        ...
        test_file = safe_tmp_path / "os_spawn.pkl"
        test_file.write_bytes(pickle_data)
...
class TestSubprocessDetection:
    ...
    def test_detect_subprocess_call(self, safe_tmp_path):
        ...
        test_file = safe_tmp_path / "subprocess_call.pkl"
        test_file.write_bytes(pickle_data)
    ...
    def test_detect_subprocess_popen(self, safe_tmp_path):
        ...
        test_file = safe_tmp_path / "subprocess_popen.pkl"
        test_file.write_bytes(pickle_data)
...
class TestCommandsModuleDetection:
    ...
    def test_detect_commands_getoutput(self, safe_tmp_path):
        ...
        test_file = safe_tmp_path / "commands_getoutput.pkl"
        test_file.write_bytes(pickle_data)
    ...
    def test_detect_commands_getstatusoutput(self, safe_tmp_path):
        ...
        test_file = safe_tmp_path / "commands_getstatusoutput.pkl"
        test_file.write_bytes(pickle_data)
...
class TestPosixDetection:
    ...
    def test_detect_posix_system(self, safe_tmp_path):
        ...
        test_file = safe_tmp_path / "posix_system.pkl"
        test_file.write_bytes(pickle_data)
...
class TestComplexPatterns:
    ...
    def test_detect_chained_commands(self, safe_tmp_path):
...
"""
        ...
        test_file = safe_tmp_path / "chained_commands.pkl"
        test_file.write_bytes(pickle_data)
    ...
    def test_detect_indirect_import(self, safe_tmp_path):
        ...
        test_file = safe_tmp_path / "indirect_import.pkl"
        test_file.write_bytes(pickle_data)
