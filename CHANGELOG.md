...
- **security:** scan generic ZIP/TAR/NPZ Python members and ZIP/NPZ executable members, failing closed on malformed Python source while preserving benign source files.
