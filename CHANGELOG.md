...
- route renamed TAR-backed NeMo archives with archive-root canonical model configs through Hydra `_target_` analysis while retaining generic embedded-member checks
