...
- **security:** resolve `six.moves.getoutput` and `six.moves.cPickle`
  compatibility aliases, including vendored `six` copies, in pickle call-graph
  analysis so subprocess and pickle deserializer wrappers are blocked
