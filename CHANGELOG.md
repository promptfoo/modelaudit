...
- fail closed and cap downstream scanning and metadata listings when PyTorch ZIP archives exceed the configured entry limit, while preserving parent structure attribution across nested limits
