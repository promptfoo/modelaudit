...
- **security:** detect protocol 0/1 pickle streams whose dangerous opcode appears after large trivial padding or just beyond the probe boundary, and preserve rule codes across cached scan-result round trips
