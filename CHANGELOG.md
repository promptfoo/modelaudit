...
- **security:** recursively scan all members of content-routed `.keras` ZIP archives and normalize root member lookups so embedded payloads and `./config.json` entries are not skipped
