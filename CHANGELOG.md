...
- suppress source-trusted inert Hugging Face training metadata and safe NumPy RNG-state reconstruction noise while keeping unresolved or shadowed PyTorch ZIP framework metadata suspicious unless trusted source can be inspected
