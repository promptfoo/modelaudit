...
- **security:** detect CVE-2019-6446 in NumPy scanner when object-dtype arrays are found, with informational attribution (CVSS 9.8) due potential pickle deserialization via `allow_pickle=True`
