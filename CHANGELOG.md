...
- harden LZ4-compressed Joblib inspection ([#1776](https://github.com/promptfoo/modelaudit/issues/1776)) ([fac0ede](https://github.com/promptfoo/modelaudit/commit/fac0edee89427e05cff7d8dffec343c1140c7755))
...
## [0.2.48](https://github.com/promptfoo/modelaudit/compare/v0.2.47...v0.2.48) (2026-06-24)

### Bug Fixes

- accept gzip-framed NeMo archives ([#1634](https://github.com/promptfoo/modelaudit/issues/1634)) ([7be6b46](https://github.com/promptfoo/modelaudit/commit/7be6b46a20c9689f3a6dd48530691d155998f0fb))
- audit dependencies for source changes ([#1535](https://github.com/promptfoo/modelaudit/issues/1535)) ([bf1e109](https://github.com/promptfoo/modelaudit/commit/bf1e1094fb493742de61e50f8a4cce1facb638bb))
- avoid exact-budget cloud pickle false positives ([#1595](https://github.com/promptfoo/modelaudit/issues/1595)) ([350baa0](https://github.com/promptfoo/modelaudit/commit/350baa02bb17541c38733e1adc7a4407743df6d7))
- bind direct shard cache to siblings ([#1543](https://github.com/promptfoo/modelaudit/issues/1543)) ([45bf167](https://github.com/promptfoo/modelaudit/commit/45bf1671e369f64ad9b397a9e00f31999a872d71))
- bound executorch zip scanning ([#1546](https://github.com/promptfoo/modelaudit/issues/1546)) ([ff9e1ae](https://github.com/promptfoo/modelaudit/commit/ff9e1aef042e847ed20a5dbd14c96a8550e3b467))
- bound jinja scalar range render probes ([#1553](https://github.com/promptfoo/modelaudit/issues/1553)) ([c00542e](https://github.com/promptfoo/modelaudit/commit/c00542e55de047877614931ddb2cb36058933bca))
- bound joblib decompression output ([#1522](https://github.com/promptfoo/modelaudit/issues/1522)) ([98f41b1](https://github.com/promptfoo/modelaudit/commit/98f41b1aa49ea4aac061319a9b2f8204d5bb7e7c))
- bound keras zip config traversal ([#1555](https://github.com/promptfoo/modelaudit/issues/1555)) ([6e6ba57](https://github.com/promptfoo/modelaudit/commit/6e6ba57bfe0d9fbbef5ab7b8116432353daca8b2))
- bound manifest jinja collection traversal ([#1561](https://github.com/promptfoo/modelaudit/issues/1561)) ([23b6ca2](https://github.com/promptfoo/modelaudit/commit/23b6ca20a2c857eeb37f0835aa6d2e60c4f8b31e))
- bound OCI layer extraction budgets ([#1566](https://github.com/promptfoo/modelaudit/issues/1566)) ([5f96b42](https://github.com/promptfoo/modelaudit/commit/5f96b4237dc2a9144f5b3dd8a96056efae71e06c))
...
- bound sevenzip member name collection ([#1574](https://github.com/promptfoo/modelaudit/issues/1574)) ([fb36ad8](https://github.com/promptfoo/modelaudit/commit/fb36ad8077012985b1137f04ebd78be8cac3823d))
- bound stream analysis reads ([#1525](https://github.com/promptfoo/modelaudit/issues/1525)) ([d44deb8](https://github.com/promptfoo/modelaudit/commit/d44deb828deaf6659ee679752d47a4486303db93))
- bound weight distribution tensor extraction ([#1581](https://github.com/promptfoo/modelaudit/issues/1581)) ([dc0051c](https://github.com/promptfoo/modelaudit/commit/dc0051c5bd1fa22f3779b94e9624a78f46da37d1))
- calibrate legacy PyTorch storage persistent IDs ([#1652](https://github.com/promptfoo/modelaudit/issues/1652)) ([4a28b7f](https://github.com/promptfoo/modelaudit/commit/4a28b7f7a7eb5f7a91b44e1cd49f95af427c39e7))
- calibrate onnx custom domain findings ([149cde4](https://github.com/promptfoo/modelaudit/commit/149cde43764eaa91d8d6b20f6da66ca9d4987a92))
- calibrate validated ONNX alternate framing ([59ec990](https://github.com/promptfoo/modelaudit/commit/59ec990ec55f4cab8457038fe2635baac8febc51))
- **ci:** raise test job timeout for instrumented main lane ([#1625](https://github.com/promptfoo/modelaudit/issues/1625)) ([94e98ca](https://github.com/promptfoo/modelaudit/commit/94e98cae032cd075d785c52ced2c1db4742f4dc3))
- clarify and enforce telemetry privacy ([#1592](https://github.com/promptfoo/modelaudit/issues/1592)) ([33186db](https://github.com/promptfoo/modelaudit/commit/33186dbcf2ba0335d48271891b1fde32e466595c))
- classify pytorch zip symlink targets ([#1573](https://github.com/promptfoo/modelaudit/issues/1573)) ([c7e1699](https://github.com/promptfoo/modelaudit/commit/c7e1699d4b874f02e0e8eb99c881a36cbda1c927))
- classify tar link escapes as symlinks ([#1578](https://github.com/promptfoo/modelaudit/issues/1578)) ([edb65b2](https://github.com/promptfoo/modelaudit/commit/edb65b2df849474c6a1576baf14713e5de195042))
- classify text sidecar security findings ([#1465](https://github.com/promptfoo/modelaudit/issues/1465)) ([a3a561c](https://github.com/promptfoo/modelaudit/commit/a3a561c991e24fee864a7b0a37a29069cba4a7ca))
- **cli:** make streaming dry runs non-executing ([c0059d8](https://github.com/promptfoo/modelaudit/commit/c0059d8189e5d3ef1b94764f38360218050b3820))
- close authorization evidence redaction gaps ([#1596](https://github.com/promptfoo/modelaudit/issues/1596)) ([4606b59](https://github.com/promptfoo/modelaudit/commit/4606b59ee684edba81538a3305dd3f35d2276b42))
- close JIT replay review gaps ([#1519](https://github.com/promptfoo/modelaudit/issues/1519)) ([69928bc](https://github.com/promptfoo/modelaudit/commit/69928bc749bc07f4693510f274881025391ddcb1))
- close network redaction follow-up gaps ([#1518](https://github.com/promptfoo/modelaudit/issues/1518)) ([c6fa017](https://github.com/promptfoo/modelaudit/commit/c6fa0175f3771665c8f4f1cb066f8badb0a71a24))
- **cloud:** bound directory analysis before download ([#1621](https://github.com/promptfoo/modelaudit/issues/1621)) ([7bf4531](https://github.com/promptfoo/modelaudit/commit/7bf4531facd640eba05bf324a15d7f599cea01f7))
- constrain direct sharded symlink expansion ([#1463](https://github.com/promptfoo/modelaudit/issues/1463)) ([9a9f1df](https://github.com/promptfoo/modelaudit/commit/9a9f1dfd6dd760adddd20e775d6f039933c36941))
- contain cloud object download paths ([#1541](https://github.com/promptfoo/modelaudit/issues/1541)) ([17efed9](https://github.com/promptfoo/modelaudit/commit/17efed9c294b55d89344ade0a714aedfa6f05e9e))
- contain mlflow download return paths ([#1563](https://github.com/promptfoo/modelaudit/issues/1563)) ([4239134](https://github.com/promptfoo/modelaudit/commit/423913409542aa6e4c3fc5eccffb2d6b1cb1f218))
...
- deduplicate onnx custom domain findings ([#1656](https://github.com/promptfoo/modelaudit/issues/1656)) ([2bca0c0](https://github.com/promptfoo/modelaudit/commit/2bca0c063a724239e6e74a3a6664ef7cdc9ab3c5))
- **deps:** require msgpack 1.2.1 ([#1705](https://github.com/promptfoo/modelaudit/issues/1705)) ([d028a15](https://github.com/promptfoo/modelaudit/commit/d028a154fa42a752bead01d2c58f9b343e4205cf))
...
- detect explicit keras get_file tar extraction ([#1556](https://github.com/promptfoo/modelaudit/issues/1556)) ([e15963f](https://github.com/promptfoo/modelaudit/commit/e15963f3355aa85d04e9d7c766e7591450c56fb3))
- detect flax msgpack byte keys ([#1548](https://github.com/promptfoo/modelaudit/issues/1548)) ([e640403](https://github.com/promptfoo/modelaudit/commit/e640403c8490ebfe99abd0a723e1993ff986b1c5))
- detect operator archive Python execution paths ([#1538](https://github.com/promptfoo/modelaudit/issues/1538)) ([ae81048](https://github.com/promptfoo/modelaudit/commit/ae810485e9339aeeb2c55ff7958996ae82006fea))
- detect pickle binunicode8 setitem abuse ([#1524](https://github.com/promptfoo/modelaudit/issues/1524)) ([43d2fb8](https://github.com/promptfoo/modelaudit/commit/43d2fb80731878757b307e3fc018f7097b072fae))
- disable unsafe metadata deserialization ([#1523](https://github.com/promptfoo/modelaudit/issues/1523)) ([5cf4945](https://github.com/promptfoo/modelaudit/commit/5cf4945de43de7f977cce985410a9bb6bacce4a7))
- discover hidden executorch pickle members ([#1547](https://github.com/promptfoo/modelaudit/issues/1547)) ([1f2059f](https://github.com/promptfoo/modelaudit/commit/1f2059f72095fbc2ce44a1090eef3c2a70f152f7))
- dispatch logical model directory scanners ([45532e3](https://github.com/promptfoo/modelaudit/commit/45532e39a9d426cbc6696789cddc03c8735e2ef5))
- distrust Keras artifact runtime versions ([#1559](https://github.com/promptfoo/modelaudit/issues/1559)) ([fd38c3b](https://github.com/promptfoo/modelaudit/commit/fd38c3b2a480d555230372df0f55d8160b5c15a5))
- **docker:** preserve native architecture fallback ([#1690](https://github.com/promptfoo/modelaudit/issues/1690)) ([8a466f4](https://github.com/promptfoo/modelaudit/commit/8a466f454f696ef811db3e63a358abb370555a0c))
- **docker:** update Python digest and honor target architecture ([#1687](https://github.com/promptfoo/modelaudit/issues/1687)) ([303f7c1](https://github.com/promptfoo/modelaudit/commit/303f7c189158b9af2a5101c2130b662dc019008a))
- enforce MLflow acquisition budgets ([#1442](https://github.com/promptfoo/modelaudit/issues/1442)) ([0d38924](https://github.com/promptfoo/modelaudit/commit/0d3892483e8a74d1c0c1c4dd71da9b4395a5b63e))
- enforce MLflow artifact backend allowlist ([#1564](https://github.com/promptfoo/modelaudit/issues/1564)) ([74ebeae](https://github.com/promptfoo/modelaudit/commit/74ebeae05bed7218e02221149437210f5c425143))
- escape text output controls ([#1580](https://github.com/promptfoo/modelaudit/issues/1580)) ([164bbb9](https://github.com/promptfoo/modelaudit/commit/164bbb9f45094928cb8fb25f79b868e4c8e791cb))
- exclude Hugging Face cache sidecars ([00dcc11](https://github.com/promptfoo/modelaudit/commit/00dcc11f8b1db3b917be989e8c5ce38273bfa839))
- fail closed on capped DVC outputs ([#1472](https://github.com/promptfoo/modelaudit/issues/1472)) ([f854808](https://github.com/promptfoo/modelaudit/commit/f85480861e06d5a4868758d5306bd37e65fea07c))
- fail closed on invalid joblib trusted tails ([#1554](https://github.com/promptfoo/modelaudit/issues/1554)) ([4e957b0](https://github.com/promptfoo/modelaudit/commit/4e957b012a21e113c30a1bc8d54089a0db14f75c))
...
- fail closed on raw detector errors ([#1457](https://github.com/promptfoo/modelaudit/issues/1457)) ([85e7c8c](https://github.com/promptfoo/modelaudit/commit/85e7c8c26d95da65b6ba6802e1859e79a42de473))
- fail closed on unresolved DVC outputs ([#1488](https://github.com/promptfoo/modelaudit/issues/1488)) ([d3dd63f](https://github.com/promptfoo/modelaudit/commit/d3dd63ffaafa1436c38788522e575ec258a0f9c7))
- fail closed when keras h5 lacks h5py ([#1432](https://github.com/promptfoo/modelaudit/issues/1432)) ([0e81de7](https://github.com/promptfoo/modelaudit/commit/0e81de7a8f98fb9b5e658c9af24351fdadd29f3c))
- fail gated Hugging Face acquisitions honestly ([#1646](https://github.com/promptfoo/modelaudit/issues/1646)) ([8192304](https://github.com/promptfoo/modelaudit/commit/819230475df9d07810b040fb1098e1f1d7145727))
- **gguf:** calibrate metadata string findings ([f3e77e4](https://github.com/promptfoo/modelaudit/commit/f3e77e459c1b5e8e48248d5ef0ab13207b77a351))
- harden cloud acquisition routing budgets ([#1540](https://github.com/promptfoo/modelaudit/issues/1540)) ([d958807](https://github.com/promptfoo/modelaudit/commit/d95880729eba446a4e35be2ba05e2f1e7e89cad8))
- harden Flax regex streaming ([#1600](https://github.com/promptfoo/modelaudit/issues/1600)) ([0c69e69](https://github.com/promptfoo/modelaudit/commit/0c69e696807a2654455c245c739e9843faa6e49a))
- harden JFrog redirect targets ([#1520](https://github.com/promptfoo/modelaudit/issues/1520)) ([ea54e39](https://github.com/promptfoo/modelaudit/commit/ea54e39af35f7cc76ad4627c6ea1a68c6c7a0acb))
- harden Keras H5 CVE coverage ([#1558](https://github.com/promptfoo/modelaudit/issues/1558)) ([54fd488](https://github.com/promptfoo/modelaudit/commit/54fd488a0776db54022cb86070179ff72fbc4a94))
- harden large tokenizer JSON EOF ownership proof ([#1695](https://github.com/promptfoo/modelaudit/issues/1695)) ([9edbaba](https://github.com/promptfoo/modelaudit/commit/9edbaba60d54ae50606576ab14674d776319d101))
- harden NeMo Hydra helper arguments ([#1565](https://github.com/promptfoo/modelaudit/issues/1565)) ([787a1ab](https://github.com/promptfoo/modelaudit/commit/787a1abdf8a01474ca3e2d15f143ff25ac7e07b6))
- harden NeMo Hydra I/O analysis ([#1426](https://github.com/promptfoo/modelaudit/issues/1426)) ([6670ad3](https://github.com/promptfoo/modelaudit/commit/6670ad3fb77ec08fa186066382ff8ad0f9a40eb1))
- harden pickle CVE stream probing ([#1603](https://github.com/promptfoo/modelaudit/issues/1603)) ([76352d7](https://github.com/promptfoo/modelaudit/commit/76352d787e712d52833a72b985321d09094e3bfb))
...
- harden R named argument detection ([#1510](https://github.com/promptfoo/modelaudit/issues/1510)) ([5c4c4ae](https://github.com/promptfoo/modelaudit/commit/5c4c4ae4236bfa315ae9c03c5c2b4087b96c219f))
- harden streamed TAR and NeMo inspection ([#1665](https://github.com/promptfoo/modelaudit/issues/1665)) ([c52b914](https://github.com/promptfoo/modelaudit/commit/c52b914baa281dcd250e594942fe0d7889771ca2))
- harden telemetry privacy redaction ([#1579](https://github.com/promptfoo/modelaudit/issues/1579)) ([532ae59](https://github.com/promptfoo/modelaudit/commit/532ae5969abe887bd67f67ba71c75d80ae2821c6))
- **huggingface:** avoid probes for selection-skipped shards ([#1633](https://github.com/promptfoo/modelaudit/issues/1633)) ([94a89df](https://github.com/promptfoo/modelaudit/commit/94a89df713b6c5a3c1c7d025ad13a1906fff2c54))
- inspect large ONNX models without full reads ([#1664](https://github.com/promptfoo/modelaudit/issues/1664)) ([5befbef](https://github.com/promptfoo/modelaudit/commit/5befbef2ff38bbdfa959ca18845ac0fc273be243))
...
- **jinja:** require executable SSTI context ([#1647](https://github.com/promptfoo/modelaudit/issues/1647)) ([4cd9a18](https://github.com/promptfoo/modelaudit/commit/4cd9a182cb573577f19e5e95cd17c06d136b80f7))
- **jit:** bound alias replay before safe runpy calls ([#1685](https://github.com/promptfoo/modelaudit/issues/1685)) ([7bd62ec](https://github.com/promptfoo/modelaudit/commit/7bd62ecc06f4db1058b95fb2966da09c94ba1b65))
- **jit:** bound passive reference replay ([#1681](https://github.com/promptfoo/modelaudit/issues/1681)) ([e542e54](https://github.com/promptfoo/modelaudit/commit/e542e54c7ffa86717ddec359d51073fb8fdc5426))
- keep sentencepiece tokenizers out of xgboost routing ([5ac9efc](https://github.com/promptfoo/modelaudit/commit/5ac9efc938837108b3f76b3c82669cfb939fe5d0))
- **llamafile:** stream executable runtime coverage ([#1622](https://github.com/promptfoo/modelaudit/issues/1622)) ([8d6c486](https://github.com/promptfoo/modelaudit/commit/8d6c4864fe2ea833ceaef1b9803d225afb1e8d69))
- **manifest:** fail closed on scan timeout ([#1615](https://github.com/promptfoo/modelaudit/issues/1615)) ([c769097](https://github.com/promptfoo/modelaudit/commit/c7690976719aabdd3152948a26c1ec07d9294b1f))
- **onnx:** classify custom operator domains ([#1614](https://github.com/promptfoo/modelaudit/issues/1614)) ([d5a6ac2](https://github.com/promptfoo/modelaudit/commit/d5a6ac28f751ad5f917ee38506e8ac6f4834ad96))
- **onnx:** reduce weight anomaly noise ([#1608](https://github.com/promptfoo/modelaudit/issues/1608)) ([d5ae100](https://github.com/promptfoo/modelaudit/commit/d5ae1005f87bd5c1ea2c81b910638965860bd3b2))
- paginate large Hugging Face inventories ([e393dc0](https://github.com/promptfoo/modelaudit/commit/e393dc0fce399497e3652cca50686f6442364e18))
- **pickle:** bound legacy PyTorch control streams ([#1619](https://github.com/promptfoo/modelaudit/issues/1619)) ([e407fb4](https://github.com/promptfoo/modelaudit/commit/e407fb4fbc9837cea928ef20a95d34c4b0a9c42a))
...
- preflight generic zip entry limits ([#1549](https://github.com/promptfoo/modelaudit/issues/1549)) ([9da67c9](https://github.com/promptfoo/modelaudit/commit/9da67c962dedec5e2405265d9568b82c5ccfbdb6))
- preserve active HF correlation findings ([#1551](https://github.com/promptfoo/modelaudit/issues/1551)) ([603c782](https://github.com/promptfoo/modelaudit/commit/603c782fb8d4b0120be430589a4a1ca046b76709))
- preserve active HF findings ([#1601](https://github.com/promptfoo/modelaudit/issues/1601)) ([29af2de](https://github.com/promptfoo/modelaudit/commit/29af2dedd63f5901a206417dd758fba6ed95d9af))
- preserve default scanner read caps ([#1542](https://github.com/promptfoo/modelaudit/issues/1542)) ([c55de21](https://github.com/promptfoo/modelaudit/commit/c55de216637b0ca341cd6659d915d1cc2c4f5e2c))
- preserve ONNX external data in HF streaming ([#1635](https://github.com/promptfoo/modelaudit/issues/1635)) ([67fd0d4](https://github.com/promptfoo/modelaudit/commit/67fd0d4e0f30ece4e9f712c71c71e96cba67d041))
- preserve OpenVINO companions in HF streaming ([#1642](https://github.com/promptfoo/modelaudit/issues/1642)) ([2a2aebc](https://github.com/promptfoo/modelaudit/commit/2a2aebc00b9fed261325dcd3d7da5bdd989d3ccd))
- preserve unusual docs filenames in formatter ([#1533](https://github.com/promptfoo/modelaudit/issues/1533)) ([e1b066d](https://github.com/promptfoo/modelaudit/commit/e1b066d431a89a071a29243de6355cdbca26cf79))
- prevent CatBoost credential-redaction ReDoS ([#1584](https://github.com/promptfoo/modelaudit/issues/1584)) ([493436e](https://github.com/promptfoo/modelaudit/commit/493436e795be760b8dcec031d4d60e9a044091f1))
- preview Hugging Face dry-run scans ([#1645](https://github.com/promptfoo/modelaudit/issues/1645)) ([fd40a81](https://github.com/promptfoo/modelaudit/commit/fd40a81e74f5b999ca425829ec11abe2594d39da))
...
- **pytorch:** distinguish producer metadata from runtime CVEs ([#1643](https://github.com/promptfoo/modelaudit/issues/1643)) ([beb34c6](https://github.com/promptfoo/modelaudit/commit/beb34c6940cd69b42069040633b4e9219c584d52))
- **pytorch:** stream bounded analysis of large legacy shards ([93c0e5b](https://github.com/promptfoo/modelaudit/commit/93c0e5b4554bdb4a9153bf4712f5bb0fe7c9405e))
...
- recognize GGUF BF16 tensor type ([#1632](https://github.com/promptfoo/modelaudit/issues/1632)) ([05443d2](https://github.com/promptfoo/modelaudit/commit/05443d25a163db86f4e0bee32f30c0309f2d559c))
- reconcile cross-directory model shards ([#1587](https://github.com/promptfoo/modelaudit/issues/1587)) ([b143688](https://github.com/promptfoo/modelaudit/commit/b143688a933c275ce1ef3c64e9e15c99b08b4671))
- redact authorization evidence variants ([#1544](https://github.com/promptfoo/modelaudit/issues/1544)) ([f3ad852](https://github.com/promptfoo/modelaudit/commit/f3ad8528a813cc1077e9ba40f91ad747ceab38df))
- redact CatBoost evidence secrets ([#1428](https://github.com/promptfoo/modelaudit/issues/1428)) ([5e56d8a](https://github.com/promptfoo/modelaudit/commit/5e56d8a3d72d6bbc5b4d00d941ae36cf4082c3da))
- redact exported source identifiers ([#1530](https://github.com/promptfoo/modelaudit/issues/1530)) ([6f4407d](https://github.com/promptfoo/modelaudit/commit/6f4407d7f28f7dd61a6f520a493bf85c1a68123f))
- redact Keras and TensorFlow scanner evidence ([#1560](https://github.com/promptfoo/modelaudit/issues/1560)) ([8e9d119](https://github.com/promptfoo/modelaudit/commit/8e9d119c3bd20f08ca3b5cecfb00c785bc04bc90))
- redact keras h5 lambda previews ([#1435](https://github.com/promptfoo/modelaudit/issues/1435)) ([9830ef6](https://github.com/promptfoo/modelaudit/commit/9830ef6048690eae5ee147d1bc2fbe64677dc011))
- redact mlflow download errors ([#1562](https://github.com/promptfoo/modelaudit/issues/1562)) ([5067f88](https://github.com/promptfoo/modelaudit/commit/5067f88d0f87b642a0025d289d3a9e7d91e2bf99))
- redact network finding snippets ([#1438](https://github.com/promptfoo/modelaudit/issues/1438)) ([36f26f0](https://github.com/promptfoo/modelaudit/commit/36f26f0d850e76248c3361e33df5a56bd5e5372d))
- redact stream source urls ([#1429](https://github.com/promptfoo/modelaudit/issues/1429)) ([77b2295](https://github.com/promptfoo/modelaudit/commit/77b2295632110f0f80ed4afd87c863f06860352d))
- reduce JIT script detector false positives and negatives ([#1513](https://github.com/promptfoo/modelaudit/issues/1513)) ([0984542](https://github.com/promptfoo/modelaudit/commit/0984542a4522c668af337796e0694802f68a0d05))
- reject cleartext remote model sources ([#1527](https://github.com/promptfoo/modelaudit/issues/1527)) ([6524032](https://github.com/promptfoo/modelaudit/commit/6524032a8ee7e3cd50cdd4f17ee958ec383357b3))
- reject jfrog folder local path collisions ([#1552](https://github.com/promptfoo/modelaudit/issues/1552)) ([e22f4e1](https://github.com/promptfoo/modelaudit/commit/e22f4e1736fb8ad86e4254e5f6db60df37ec6976))
- reject symlinked CLI report outputs ([#1485](https://github.com/promptfoo/modelaudit/issues/1485)) ([d4003a6](https://github.com/promptfoo/modelaudit/commit/d4003a6d946f91e831b13021430c08002322d7da))
...
- report complete Hugging Face inventory capabilities ([#1648](https://github.com/promptfoo/modelaudit/issues/1648)) ([d8888d1](https://github.com/promptfoo/modelaudit/commit/d8888d1f313bcf75d017b7d92a76a9b66d9d7d45))
- require defusedxml for pmml parsing ([#1570](https://github.com/promptfoo/modelaudit/issues/1570)) ([b8053d6](https://github.com/promptfoo/modelaudit/commit/b8053d68a5f71e3265e2811e4f4cf3e2c710d05d))
- require explicit opt-in for PyTorch weight loading ([#1582](https://github.com/promptfoo/modelaudit/issues/1582)) ([067dcba](https://github.com/promptfoo/modelaudit/commit/067dcba728b2007633588de5e7a1dcd16bee5ecb))
- restore cross-platform scanner baselines ([#1597](https://github.com/promptfoo/modelaudit/issues/1597)) ([2484ac7](https://github.com/promptfoo/modelaudit/commit/2484ac7e8374e0b5819cac46fafa7df7ba3548e3))
...
- restrict auth bearer token hosts ([#1539](https://github.com/promptfoo/modelaudit/issues/1539)) ([838f250](https://github.com/promptfoo/modelaudit/commit/838f25046fb94fe018b18a5a2a84e4aef3ed969e))
- restrict manual docker publish tags ([#1526](https://github.com/promptfoo/modelaudit/issues/1526)) ([1abc856](https://github.com/promptfoo/modelaudit/commit/1abc85662fbe1f6340e1fd61568d45637b0d2829))
- restrict progress hook egress ([#1571](https://github.com/promptfoo/modelaudit/issues/1571)) ([bc9419e](https://github.com/promptfoo/modelaudit/commit/bc9419e4d53cabc45d3e189d4eed910482a35c3f))
- **results:** isolate nested member integrity hashes ([#1666](https://github.com/promptfoo/modelaudit/issues/1666)) ([50e2df3](https://github.com/promptfoo/modelaudit/commit/50e2df398a8165f03cb8435fef30be0e7474a75c))
- **results:** propagate inconclusive file coverage ([#1672](https://github.com/promptfoo/modelaudit/issues/1672)) ([4ab592f](https://github.com/promptfoo/modelaudit/commit/4ab592f8c66b35dcc2ea799c2d676f3e47900972))
- route protocol-less binary pickles ([#1577](https://github.com/promptfoo/modelaudit/issues/1577)) ([ff68cb0](https://github.com/promptfoo/modelaudit/commit/ff68cb0f8296f582fce3dba1a0a210e71654a99a))
- **routing:** bound tokenizer json scanner selection ([#1638](https://github.com/promptfoo/modelaudit/issues/1638)) ([e47be19](https://github.com/promptfoo/modelaudit/commit/e47be19b696c270074bf7d8b5e2fa7026fbaf192))
- **routing:** classify tokenizer text before binary formats ([#1629](https://github.com/promptfoo/modelaudit/issues/1629)) ([067717d](https://github.com/promptfoo/modelaudit/commit/067717d1d80e464f024f1783436f9998fac7b14e))
- **routing:** keep media out of serialized scanners ([0a65650](https://github.com/promptfoo/modelaudit/commit/0a65650a2f8c26540f38634b4414b4cf10319d1b))
- **routing:** keep text assets out of Flax MessagePack ([34cad20](https://github.com/promptfoo/modelaudit/commit/34cad20e4d6a6876052aea0da19ed7ab9d2fc29a))
...
- **rules:** attribute format mismatches to s901 ([#1613](https://github.com/promptfoo/modelaudit/issues/1613)) ([22bc654](https://github.com/promptfoo/modelaudit/commit/22bc654b6a01dd396c45ea1428a73ddac866ad3a))
- **safetensors:** accept current tensor dtypes ([#1610](https://github.com/promptfoo/modelaudit/issues/1610)) ([fd6f0ea](https://github.com/promptfoo/modelaudit/commit/fd6f0ea7cad91bc5a5323e233508c43b6309178c))
- **safetensors:** accept empty tensor offsets ([#1607](https://github.com/promptfoo/modelaudit/issues/1607)) ([9d547bb](https://github.com/promptfoo/modelaudit/commit/9d547bb730e12929ee99aaa3b01a14ac8ddcd460))
- **safetensors:** prefer bounded framing over zlib magic ([#1623](https://github.com/promptfoo/modelaudit/issues/1623)) ([54b01e1](https://github.com/promptfoo/modelaudit/commit/54b01e1dd75b01130cff445091825454580f3252))
- scan ExecuTorch raw payload indicators ([#1545](https://github.com/promptfoo/modelaudit/issues/1545)) ([c37246d](https://github.com/promptfoo/modelaudit/commit/c37246df53f563fcbd46c6a7fb408de9da3d9741))
- scan model links in oci layers ([#1567](https://github.com/promptfoo/modelaudit/issues/1567)) ([f85e0ef](https://github.com/promptfoo/modelaudit/commit/f85e0efc54b23c0fe296f6fe2202620b882f5ca8))
- **scripts:** contain corpus QA output paths ([#1618](https://github.com/promptfoo/modelaudit/issues/1618)) ([a33b710](https://github.com/promptfoo/modelaudit/commit/a33b710a4516047855f61958b9c763f68eeb9623))
- **scripts:** quote whitelist model ids safely ([#1616](https://github.com/promptfoo/modelaudit/issues/1616)) ([8f57897](https://github.com/promptfoo/modelaudit/commit/8f57897760c963f4caadc59dbca2fcaa13812cd9))
- sniff Hugging Face selective downloads ([#1412](https://github.com/promptfoo/modelaudit/issues/1412)) ([9576eb7](https://github.com/promptfoo/modelaudit/commit/9576eb7d3db0f3a3ea9f4e621e4c783f777f8f57))
- stream Flax msgpack analysis ([#1589](https://github.com/promptfoo/modelaudit/issues/1589)) ([0c13d9e](https://github.com/promptfoo/modelaudit/commit/0c13d9ea1f25cf2f94d6dfb6f58e03d7a48351a3))
- stream Hugging Face SafeTensors shard headers ([#1667](https://github.com/promptfoo/modelaudit/issues/1667)) ([e6186dc](https://github.com/promptfoo/modelaudit/commit/e6186dccc1fde80dbdd02e959330a5dcccba5b0f))
- stream large Flax MessagePack tensors ([16e1bec](https://github.com/promptfoo/modelaudit/commit/16e1beca3cccc26041be064b8c1b951845842cfd))
- stream large Keras HDF5 inspection ([0ff7b62](https://github.com/promptfoo/modelaudit/commit/0ff7b6260628dfd9a3bc2f31c52f725ad808ec3d))
...
- **text:** contextualize tokenizer vocabulary indicators ([#1653](https://github.com/promptfoo/modelaudit/issues/1653)) ([13431e4](https://github.com/promptfoo/modelaudit/commit/13431e4388136a4d510ff328928e54a049d6d200))
- **text:** deduplicate model-card indicators ([#1631](https://github.com/promptfoo/modelaudit/issues/1631)) ([5ff4247](https://github.com/promptfoo/modelaudit/commit/5ff42477ad03f71a216210eb35b4f6a7ea2a97d6))
- **text:** ignore pip version pins in documentation ([#1630](https://github.com/promptfoo/modelaudit/issues/1630)) ([45e6d62](https://github.com/promptfoo/modelaudit/commit/45e6d6207140a19330ffdbee81e1e6fc3285496b))
...
- tolerate picklescan reports without private metadata ([cdc8b8b](https://github.com/promptfoo/modelaudit/commit/cdc8b8b6989dbe2b67675765599cb6361124630d))
- validate hf direct url paths ([#1550](https://github.com/promptfoo/modelaudit/issues/1550)) ([def9169](https://github.com/promptfoo/modelaudit/commit/def9169bd2f7ab06d6e094023a52ab6c575bfbc7))
- validate OCI layer member metadata ([#1444](https://github.com/promptfoo/modelaudit/issues/1444)) ([a7235e1](https://github.com/promptfoo/modelaudit/commit/a7235e1018ece31a93d531e064667ec371d4bea4))
...
- verify rustup installer in docker builds ([#1529](https://github.com/promptfoo/modelaudit/issues/1529)) ([51f2336](https://github.com/promptfoo/modelaudit/commit/51f2336ed16d65876032539f4e4a9f047f030dff))

### Performance Improvements

- **hashing:** read in 8 MB chunks instead of 8 KB ([#1709](https://github.com/promptfoo/modelaudit/issues/1709)) ([6caa259](https://github.com/promptfoo/modelaudit/commit/6caa259d3c2e8260d23d6500519ae28a58922fa3))
