...
- **security**: detect CVE-2025-51480 ONNX save_external_data arbitrary file overwrite via path traversal (CVSS 8.8), with logic fix checking traversal before file existence
