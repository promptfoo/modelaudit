...
- detect and safely bound NeMo Hydra network and file-access callable targets, including NumPy and file-opening constructor aliases, that can perform SSRF, local reads, or arbitrary writes
