...
- refresh audited aiohttp, cryptography, and MLflow lock resolutions after upstream dependency advisories surfaced in CI
...
- preserve bounded ONNX quantized and generated-value weight lineage across QDQ, integer, and value-producing operators; honor declared dequantization precision; fail closed on incomplete proofs, malformed quantization evidence, or retained-copy budget exhaustion; and cluster duplicate weight anomalies only across byte-identical exports
