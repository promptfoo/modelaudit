...
- suppress inert import-only Hugging Face training metadata and safe NumPy RNG-state reconstruction noise while keeping unresolved PyTorch ZIP framework metadata reconstruction suspicious unless trusted source can be inspected
