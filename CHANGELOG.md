...
- keep result-cache resolution fingerprints aligned with cached path-importer misses and trusted `FileFinder` state so shared scans cannot reuse stale origin trust
