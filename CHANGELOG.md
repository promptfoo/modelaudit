...
- **security:** scan raw protocol-0/1 `.joblib` pickles directly, support gzip/bzip2/lzma/zlib wrapped Joblib payloads with bounded output and trailing-data checks, and preserve failed `success` status when embedded pickle findings are CRITICAL
