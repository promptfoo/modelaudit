...
- **security:** scan every duplicate PyTorch ZIP member by physical archive entry and flag conflicting duplicate names so benign trailing `data.pkl` entries cannot shadow malicious earlier payloads
