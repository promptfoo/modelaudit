...
- **security:** enforce Flax msgpack scanner file-size limits before full reads, scan trailing msgpack stream objects for malicious payloads, and preserve failed status when CRITICAL findings are reported
