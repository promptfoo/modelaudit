...
- fail closed on standalone Keras HDF5 scans when `h5py` is unavailable, including ZIP-prefixed and extensionless user-block files, without reviving stale cached results
