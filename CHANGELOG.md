...
- distinguish PyTorch checkpoint producer-version metadata from active runtime CVE applicability while preserving artifact-level pickle and tensor-structure findings
