...
3. Keep scanner dependencies current (`modelaudit[all]` for broad portable coverage; add `modelaudit[tensorflow]` on Python 3.11-3.12 only for TensorFlow runtime-dependent paths).
