...
| TensorFlow SavedModel/MetaGraph | `.pb`, `.meta`, SavedModel directories                            | Yes (vendored protos)                                 | `modelaudit[tensorflow]` for TensorFlow-dependent checkpoint/weight analysis |
