...
- Jinja2 content routing recognizes renamed standalone templates only when their content carries high-signal SSTI indicators; oversized or unreadable identified templates are reported as incomplete coverage instead of clean results, while ordinary chat-template formatting is not promoted by this route.
