...
- Flax/JAX content routing recognizes renamed MessagePack maps only when they expose checkpoint-state roots such as `params` or `opt_state`; arbitrary MessagePack maps are not promoted into the scan set.
