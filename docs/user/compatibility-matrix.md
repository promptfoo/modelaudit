...
| RKNN models                     | `.rknn`, signature-valid renamed artifacts                         | Yes (static bounded metadata checks)                      | None                                                                                             |
...
| TFLite                          | `.tflite`, signature-valid renamed artifacts                       | No                                                        | `modelaudit[tflite]` (required)                                                                  |
| ExecuTorch                      | `.ptl`, `.pte`, signature-valid standalone renamed artifacts       | Yes (static binary/archive checks)                        | None                                                                                             |
...
- Renamed R workspace files require both a workspace header and serialization marker; short text marker lookalikes are not promoted as renamed models.
