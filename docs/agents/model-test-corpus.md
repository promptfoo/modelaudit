...
> This catalog is maintained for contributors and scanner regression testing. It is intentionally kept under
> `docs/agents/` instead of user-facing documentation.
...
| --- | ----------------------------------------------------------------- | --------------- | ------------ | ------ | ---------------------------------------------------------------------------------------------------------- |
| 1   | `openai/clip-vit-base-patch32`                                    | Computer Vision | Hugging Face | Clean  | CLIP vision-text baseline - established CV model                                                           |
| 2   | `google/vit-base-patch16-224`                                     | Computer Vision | Hugging Face | Clean  | Google Vision Transformer - standard ViT baseline                                                          |
| 3   | `facebook/detr-resnet-50`                                         | Computer Vision | Hugging Face | Clean  | DETR object detection - transformer detection model                                                        |
| 4   | `microsoft/beit-base-patch16-224`                                 | Computer Vision | Hugging Face | Clean  | BEiT vision transformer - Microsoft ViT variant                                                            |
| 5   | `ultralytics/yolov5n`                                             | Computer Vision | PyTorch Hub  | Clean  | YOLOv5 nano - PyTorch Hub model validation                                                                 |
| 6   | `pytorch/vision:v0.13.0-mobilenet_v2`                             | Computer Vision | PyTorch Hub  | Clean  | MobileNetV2 - torchvision Hub model                                                                        |
| 7   | `scikit-learn/logistic-regression`                                | ML Algorithm    | Local        | Clean  | Logistic regression - basic sklearn pickle baseline                                                        |
| 8   | `scikit-learn/decision-tree`                                      | ML Algorithm    | Local        | Clean  | Decision tree - sklearn pickle format                                                                      |
| 9   | `scikit-learn/svm`                                                | ML Algorithm    | Local        | Clean  | SVM - sklearn pickle format                                                                                |
| 10  | `scikit-learn/random-forest`                                      | ML Algorithm    | Local        | Clean  | Random forest - sklearn pickle format                                                                      |
| 11  | `scikit-learn/gradient-boosting`                                  | ML Algorithm    | Local        | Clean  | Gradient boosting - sklearn pickle format                                                                  |
| 12  | `scikit-learn/k-means`                                            | ML Algorithm    | Local        | Clean  | K-means clustering - sklearn pickle format                                                                 |
| 13  | `scikit-learn/linear-regression`                                  | ML Algorithm    | Local        | Clean  | Linear regression - sklearn pickle format                                                                  |
| 14  | `scikit-learn/ridge`                                              | ML Algorithm    | Local        | Clean  | Ridge regression - sklearn pickle format                                                                   |
| 15  | `scikit-learn/lasso`                                              | ML Algorithm    | Local        | Clean  | Lasso regression - sklearn pickle format                                                                   |
| 16  | `scikit-learn/pca`                                                | ML Algorithm    | Local        | Clean  | PCA - sklearn pickle format                                                                                |
| 17  | `scikit-learn/agglomerative-clustering`                           | ML Algorithm    | Local        | Clean  | Agglomerative clustering - sklearn pickle format                                                           |
