...
- mirror cached path-importer semantics for call-graph origin proofs, failing closed on cached misses and untrusted earlier finders while preserving trusted earlier resolutions
